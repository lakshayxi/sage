...
def score_item(item: EvalItem, answer_text: str, citation_filenames: list[str]) -> ScoreResult:
    if not item.answerable:
        ...
        return ScoreResult(correct=correct, grounded=grounded, detail=detail)
